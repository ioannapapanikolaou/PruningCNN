...
def main():
    ...
    parser.add_argument('--best',type=str, default= '/vol/research/prunepath/prune/fold1/best/', help='path to save best models')
    parser.add_argument('--pruned',type=str, default= '/vol/research/prunepath/prune/fold1/pruned/', help='path to save pruned models')
    parser.add_argument('--root_path', type=str, default='/vol/research/SF_datasets/radiology/necrosis/single_20/fold1/', help='Root path containing dataset')
    ...
    parser.add_argument('--ft_pruned',type=str, default= '/vol/research/prunepath/prune/fold1/ft_pruned/', help='path to save ft pruned models')
...
def fine_tuning_pruned_model(args):
    ...
    for percentage in pruning_percentages:    # Load the saved model
        ...
        class_weights = torch.FloatTensor([0.25,0.75]).to(device)               # change weights according to fold 
