...
def main():
    ...
    parser.add_argument('--root_path', type=str, default='/vol/research/SF_datasets/radiology/necrosis/single_20/fold3/', help='Root path containing dataset')
    ...
    parser.add_argument('--ft_pruned',type=str, default= '/vol/research/prunepath/prune/fold3.1/ft_pruned/', help='path to save ft pruned models')
...
def fine_tuning_pruned_model(args):
    ...
    for percentage in pruning_percentages:    # Load the saved model
        ...
        class_weights = torch.FloatTensor([0.28, 0.72]).to(device)               # change weights according to fold 
